      ...
      >
        ...
        >
          <div id="keep-mounted-modal-description">
            ...
            <p>
              EduOn platformasida spiker bo'lish uchun ro'yxatdan o'tganingizda,
              ushbu spiker shartlariga rioya qilishga rozilik bildirasiz. Spiker
            ...
            <li style={{ listStyle: "disc" }}>
              Kurs boshqa birovga tegishli bo’lmasligi;
            </li>
            <li style={{ listStyle: "disc" }}>
              Kursda tamaki, alkogol va odamlarni psixologiyasiga yomon ta’sir
              ko’rsatuvchi lavhalar bo’lmasligi;
            </li>
            <li style={{ listStyle: "disc" }}>
              Kursning mavzusi to’liq yoritib berilishi;
            </li>
            <li style={{ listStyle: "disc" }}>
              Kurs kontenti kursni nomi va tarifiga mos kelishi;
            </li>
            <li style={{ listStyle: "disc" }}>
              Kursda kamida 4 ta video bo’lishi;
            </li>
            <li style={{ listStyle: "disc" }}>
              Kursni davomiyligi kamida 30 minutni tashkil etishi;
            </li>
            <li style={{ listStyle: "disc" }}>
              Kurs video o'lchami 16:9 formatda bo’lishi;
            </li>
            <li style={{ listStyle: "disc" }}>
              Kurs video sifati kamida 480K bo’lishi;
            </li>
            <h3>1.2 EduOn huquqi</h3>
            <li style={{ listStyle: "disc" }}>
              {" "}
              Eduon kurs sotuvini oshirish va kursni taniqliligini oshirish
              maqsadida har bir kursga 90% gacha chegirma berish huquqiga ega;
            </li>
            <li style={{ listStyle: "disc" }}>
              {" "}
              Eduon tamonidan kurs salohiyatini ko’tarish maqsadida kurs
              ma’lumotlariga o’zgartirishlar kiritilishi mumkin, agarda kurs
              ma’lumotlarida imloviy xatolar, berilgan chegaradan ko’proq
              ma’lumot va Eduon talablariga mos kelmaydigan ma’lumotni o’z
              ichiga olsa;
            </li>
            <li style={{ listStyle: "disc" }}>
              {" "}
              Eduon, siz tarafdan noodatiy trafik yoki foydalanish shartlari
              buzilishi kuzatilsa pul o’tkazmalar, kursni Eduon saytida
              ko’rinishini to’xtatish hamda balansni muzlatish huquqiga ega;
            </li>
            <li style={{ listStyle: "disc" }}>
              {" "}
              Eduon siz tarafdan bajarilgan harakatlarga javob bermaydi.
            </li>
            <li style={{ listStyle: "disc" }}>
              {" "}
              Tasdiqlangan kursga o’zgartirish kiritilsa, Eduon shu kursni
              ommaga ko’rinishini vaqtinchalik to’xtatib va qayta tekshirish
              huquqiga ega.
            </li>
            <h2>2. Atamalar</h2>
            <h3>
            ...
            <p>
              ...
              saytga kirishda ko’rsatgan ma’lumotlari (login va parol) asosida
              amalga oshiriladi.
            </p>
            ...
            <p>
              3.1.2. Foydalanuvchi ro’yxatdan o’tgandan so’ng unga elektron
              hamyon ochiladi va o’tkazmalar shu hamyon orqali Ucoin sistemasi
              yordamida amalga oshiriladi. Ucoin haqida batafsil ma'lumotni shu
              https://universalbank.uz havolaga o'tib bilib olishingiz mumkin.
            </p>
            <p>3.1.3. Tanlagan o’quv kursi uchun to’lovni amalga oshirish.</p>
            ...
            <p>Siz quyidagilarni taqdim etasiz va kafolat berasiz:</p>
            <p>Siz aniq ma'lumotlarini taqdim etasiz va saqlaysiz;</p>
            <p>
            ...
            <p>Siz shunday qilmasligingizga kafolat berasiz:</p>
            <p>
              {" "}
            ...
            <h3>5.1.Ishonch va xavfsizlik siyosati</h3>
            ...
            <h3> 5.2.Boshqa foydalanuvchilar bilan aloqalar</h3>
            <p>
              {" "}
              Siz olgan ma'lumotlaringizdan EduOn platformasida o'sha
              talabalarga o'z xizmatlaringizni ko'rsatishdan boshqa maqsadda
            ...
            <p>
              {" "}
              Narxlar EduOn platformasida minimum 50000 so'm bo’lishi lozim. Shu
              narxga to’g’ri kelmagan holda spiker ogohlantiriladi.
            </p>
            <h2>7. To'lovlar</h2>
            <h3>7.1.Daromad ulushi</h3>

            <p>
            Daromad ulushlari EduOn ma’muriyati tomonidan 70% (Spiker), 15% (EduOn) va 15% (FINANCIAL TECHNOLOGY INNOVATION HUB) etib belgilangan. Eduon tarafidan taqdim etilgan tizimlar orqali spikerni o’zi jalb qilgan auditoriyadan kelgan daromaddan ulushlari o’zgarishi mumkin.
            </p>
            <h3>7.2 To'lovlarni qabul qilish</h3>
            <p>
            ...
            <h3>7.3.Pulni qaytarish</h3>
            <p>
              Spikerlar foydalanish shartlari bo'yicha pul mablag'lari qaytarib
              beriladigan operatsiyalardan daromad olmaydilar. Agar talaba
              tegishli spikerning to'lovini to'laganimizdan keyin pulni qaytarib
              berishini so'rasa, biz (1) o'qituvchiga yuborilgan keyingi
            ...
            <h3>7.4 Pul yechib olish</h3>
            <p>
              Spiker EduOn platformasidagi pulini kartasiga yechib olayotganida
              undan 1.5% ushlab qolinishini inobatga olishi kerak bo'ladi.
            </p>
            ...
            <h3>10.1. Ushbu shartlarni yangilash</h3>
            ...
            <h3>11. Biz bilan qanday bog'lanish mumkin</h3>
            <p>
