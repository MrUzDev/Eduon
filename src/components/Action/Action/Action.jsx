...
import "./Action.css";
import ActionImg from "../../assets/images/Group 1968.png";
        ...
        <div className="actionBody">
          <div className="container">
            ...
            <div className="rowGrid justify-between ">
              <div className="col-13 col-lg-12 col-md-24 col-sm-24">
                <div className="actionCard">
                  <h1>
                    <span> “Strategik marketing”</span> kursini hoziroq xarid
                    qiling va
                    <span> “Vafodorlik tizimi orqali savdoni oshirish”</span>
                    kursini <span>bepulga</span> oling.
                  </h1>
                  <div className="btns">
                    ...
                    <div className="demos">
                      <p>Chegirmaning tugashi</p>
                      <h4 id="demo"></h4>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-10 col-lg-11 col-md-24 col-sm-24">
