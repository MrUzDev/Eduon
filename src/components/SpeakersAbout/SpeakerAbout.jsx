                ...
                <div className="AvInfos col-12 col-lg-11 col-sm-24">
                  <div className="infos">
                    <div className="left ">
                      ...
                      {speakerInfo.telegram_url && (
                      <div className="bottom">
                        <div className="favorite">
                        <TelegramIcon style={{color: '#006aff'}}/>
                          <p className="smMedia"><a href={speakerInfo.telegram_url} target="_blank">Telegram</a></p>
                        </div>
                      </div>
                      )}
                      ...
                      <div className="bottom">
                        <div className="favorite">
                        <YouTubeIcon style={{color: '#006aff'}}/>
                          <p className="smMedia"><a href={speakerInfo.youtube_url} target="_blank">YouTube</a></p>
                        </div>
                      </div>
                      )}
                    ...
                    {speakerInfo.instagram_url && (
                      <div className="bottom">
                        <div className="favorite">
                        <InstagramIcon style={{color: '#006aff'}}/>
                          <p className="smMedia"><a href={speakerInfo.instagram_url} target="_blank">Instagram</a></p>
                        </div>
                      </div>
                      )}
                    </div>
                    <div className="right">
                      ...
                      {speakerInfo.github_url && (
                      <div className="bottom">
                        <div className="messages">
                        <GitHubIcon style={{color: '#006aff'}}/>
                          <p className="smMedia"><a href={speakerInfo.github_url} target="_blank">GitHub</a></p>
                        </div>
                      </div>
                      )}
                      ...
                      <div className="bottom">
                        <div className="messages">
                        <LinkedInIcon style={{color: '#006aff'}}/>
                          <p className="smMedia"><a href={speakerInfo.linkedin_url} target="_blank">Linkedin</a></p>
                        </div>
                      </div>
                      )}
                    </div>
