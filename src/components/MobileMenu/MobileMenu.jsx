              ...
              <div className="rowGrid">
                <div className="col-24">
                  ...
                  <ul className="rowGrid bottom">
                    ...
                    <li
                      onClick={() => {referalTk(); handleOpen(); setMobileMenuOpen(false)}}
          ...
          <>
            ...
            <div className="myAccount">
              <div className="myAccountTitle">
                ...
                <h1>{balance ? currency(balance, "UZS").replace("UZS", '').replace('soʻm', '').replace(/,/g, ".").slice(0, -3) : 0}&nbsp;so'm</h1>
              </div>
              {/* <img
                onClick={() => {
            ...
            <ul>
              ...
              <li onClick={() => {referalTk(); handleOpen(); setMobileMenuOpen(false)}} className="d-flex align-center">
                <svg
                  style={{ marginRight: "10px" }}
                  width="24"
                  height="24"
              ...
              {copied ? (
                ...
                <div className="rowGrid align-center">
                  <input
                    ...
                    disabled
                    type="text"
                    value={`https://eduon.uz/register/${referalToken}`}
                    id="myInput"
                    className="col-14"
                  ></input>
