      ...
      <div className={navStretch ? "courses ml-240" : "courses ml-100"}>
        <div className="col-24">
          ...
          <li style={{ listStyle: "disc" }}>
            ...
            ma’lumotlarida imloviy xatolar, berilgan chegaradan ko’proq ma’lumot
            va Eduon talablariga mos kelmaydigan ma’lumotni o’z ichiga olsa;
          </li>
          <li style={{ listStyle: "disc" }}>
            {" "}
          ...
          <li style={{ listStyle: "disc" }}>
            {" "}
            Tasdiqlangan kursga o’zgartirish kiritilsa, Eduon shu kursni ommaga
            ko’rinishini vaqtinchalik to’xtatib va qayta tekshirish huquqiga
            ega.
          </li>
          <h2>2. Atamalar</h2>
          <h3>
          ...
          <p>
            ...
            bo’lgan sahifa. Shaxsiy kabinetga kirish foydalanuvchining saytga
          ...
          <p>
            3.1.2. Foydalanuvchi ro’yxatdan o’tgandan so’ng unga elektron hamyon
            ochiladi va o’tkazmalar shu hamyon orqali Ucoin sistemasi yordamida
            amalga oshiriladi. Ucoin haqida batafsil ma'lumotni shu
          ...
          <p>
            ...
            berishini so'rasa, biz (1) o'qituvchiga yuborilgan keyingi to'lovdan
