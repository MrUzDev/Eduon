      ...
      <nav className="navbar">
        <div className="container">
          <div className="rowGrid justify-content-between align-center">
            ...
            <div className={!loggedIn ? "col-1 p-relative filterContainer" : "col-1 p-relative"}>
              {!status && (
                <>
                  <button
                    className="filter"
                  ...
                  >
                    <div style={price}>
                      ...
                      <div style={price_title}>
                        <label for="top">
                          <p style={pTitle_typography}>Top kurslar</p>
                        </label>
                        <div>
                          <label style={label} for="top">
                            {filterPriceValue === "top" && (
                              <svg
                                style={svg}
                                width="10"
                                height="8"
            ...
            <div className="col-10 col-lg-14">
              <div className="rowGrid justify-end align-center">
                ...
                {status && (
                  <button
                    onClick={() => {setStreamStart(false) ;navigate("/uploadCourse")}}
                  ...
                  {status  &&(
                    <>
                <button className="courseUploadButton pointer" onClick={() => streamStartOp()}> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.1317 11.34C14.5217 9.70002 13.0917 8.26997 11.4517 8.65997C10.6817 8.84997 10.0517 9.47999 9.86169 10.25C9.47169 11.89 10.9017 13.32 12.5417 12.93C13.3217 12.74 13.9517 12.11 14.1317 11.34Z" stroke="#006AFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M18.0109 17.19C19.7209 15.59 20.7909 13.32 20.7909 10.79C20.7909 5.92998 16.8509 2 12.0009 2C7.15093 2 3.21094 5.93998 3.21094 10.79C3.21094 13.33 4.29094 15.62 6.02094 17.22" stroke="#006AFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M8.00172 14.55C7.08172 13.57 6.51172 12.25 6.51172 10.79C6.51172 7.75998 8.97172 5.29999 12.0017 5.29999C15.0317 5.29999 17.4917 7.75998 17.4917 10.79C17.4917 12.25 16.9217 13.56 16.0017 14.55" stroke="#006AFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M10.3007 16.66L8.86071 18.45C7.72071 19.88 8.73071 21.99 10.5607 21.99H13.4307C15.2607 21.99 16.2807 19.87 15.1307 18.45L13.6907 16.66C12.8307 15.57 11.1707 15.57 10.3007 16.66Z" stroke="#006AFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                  Jonli Vebinar</button>
                  </>
                  )}
                ...
                <div className={!loggedIn ? 'loggenInBtn col-auto col-lg-auto' : "col-auto col-lg-auto"}>
                  <NavbarProfile
                    loggedIn={loggedIn}
                    userInfo={userInfo}
