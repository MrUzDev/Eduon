...
export default function SwiperItem(props) {
  const { myCarts , setAlertError, setLoginError, sameCourse , resData} = props;
  const { isremoved, setIsRemoved, loggedIn, setAddedToCart , addedToCart} = useContext(StateContext);
    ...
    <>
      ...
      >
        <div className="biznes_CRM">
          <div className="d-sm-flex">
            ...
            >
              <img
                ...
                src={props.stream ? `${process.env.REACT_APP_API_KEY}${sameCourse.cover_img}` : sameCourse.cover_img}
                alt="jpg"
              />
            </div>
            <div>
          ...
          <div className="discount" style={{ justifyContent: "space-between", alignItems: 'center' }}>
            <p>{sameCourse.price.toLocaleString("uz-UZ", {
                                style: "currency",
                                currency: "UZS",
            ...
            <button>
              {myCarts || addCart ? (
                 <svg
                 onClick={(e) =>{sameCourse.price ? (DeleteFromCart(e, sameCourse.id)): setAddCart(false)}}
                 width="24"
                 height="24"
                 viewBox="0 0 24 24"
                 // fill="none"
              ...
              <svg onClick={(e) => {addToCart(e, sameCourse.id); setAddCart(true)}} width="24" height="24" fill="none">
                <path
                  d="M2 2H3.74001C4.82001 2 5.67 2.93 5.58 4L4.75 13.96C4.61 15.59 5.89999 16.99 7.53999 16.99H18.19C19.63 16.99 20.89 15.81 21 14.38L21.54 6.88C21.66 5.22 20.4 3.87 18.73 3.87H5.82001"
                  stroke="#006AFF"
                  strokeWidth="1.5"
