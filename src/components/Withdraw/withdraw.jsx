      ...
      <div className="container">
        <div className="rowGrid">
          ...
          <div className="col-14 col-lg-14 col-sm-24">
            <div className="cardRegister">
              ...
              <form action="" className="account" autoComplete="off">
                <div className="password">
                  <TextField
                    className="inputs invisibleBg"
                    id="TransparentInput2"
                    sx={{
                      width: "100%",
                    ...
                    type="number"
                    label="Yechib olish miqdori"
                    variant="outlined"
                    onChange={(e) => setAmount(e.target.value)}
                  />
                  <p id="inputNum">{amout && currency(amout, "UZS").replace("UZS", '').replace('soʻm', '').replace('.00', '')}</p>
        ...
        >
          <p>
            ...
            raqamli kartasiga{" "}
            <strong>{(parseInt(amout) + parseInt(amout) * 0.015).toLocaleString("uz-UZ", {
                              style: "currency",
                              currency: "UZS",
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).replace('UZS', '')}</strong> UZS
            o’tkazmoqdasiz
          </p>
          <Button
            sx={{
